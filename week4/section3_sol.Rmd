...
# Option 2 - coding with lists
# race_categories = c("white", "black", "asian", "hispanic","native american", "others")
# Only works for converting numerical labels from 1..N to factor 

# STAR$race_labels = race_categories[race] 
```
